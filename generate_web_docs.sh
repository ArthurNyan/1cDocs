...
<ul>
<li><a href="/План_управления_проектом.html">План управления проектом</a></li>
    ...
    <div class="landing-page">
        ...
        <section class="docs-sections">
            ...
            <div class="doc-section">
                ...
                <div class="doc-cards">
                    <a href="План_управления_проектом.html" class="doc-card">
                        <h3>План управления проектом</h3>
                        <p>Перейти к документу →</p>
                    </a>
...
declare -A docs=(
    ...
    ["План_управления_проектом"]="План управления проектом|Планы управления"
